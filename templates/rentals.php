    ...
    <section id="content">
		...
		<div id="inner-content">
		    ...
		    <main id="main" role="main">
                ...
                <?php if($rows = get_field('rentals_blocks')) : // Blocks start ?>
                <!--        Repeated Blocks            -->
                    <?php foreach($rows as $row) : ?>
                    ...
                    <div class="row about_blocks">

                       <?php if($row['rental_title']) : ?>
                        <div class="columns small-12 medium-12">
                            <h2 class="section-title"><?=$row['rental_title'];?></h2>
                        </div>
                       <?php endif; ?>
                       <div class="entry-content columns small-12">
                       <div class="row">
                         <?=$row['rental_details'];?></div>
                       </div>

                    </div>
                    <div class="row about_blocks">
                        <?=do_shortcode($row['calendar_shortcode']);?>
                    </div>
